---
title: "Agotamiento Laboral Asperger"
description: "Todo lo que necesitas saber sobre agotamiento laboral asperger. Cómo se vive desde el perfil neurocognitivo Asperger en la vida real."
cluster: "Trabajo y vida adulta Asperger"
related: ["rupturas-asperger", "fortalezas-asperger", "neurodiversidad-asperger"]
...
- **Monitorea el ambiente sensorial** de forma constante: el ruido de fondo, la luz, las conversaciones ajenas, el olor del café de alguien, la silla que chirría.
- **Decodifica las interacciones sociales** de manera activa y consciente: lo que dijo el jefe en un tono raro, si el silencio en la reunión significaba algo, si el correo sin signos de exclamación indica molestia.
- **Aplica masking** durante horas: ajustar el lenguaje corporal, modular el tono, decidir cuándo hablar y cuándo no, mantener contacto visual en la medida "correcta", no responder de forma demasiado directa.
- **Gestiona la hipervigilancia social**: la anticipación constante de lo que puede salir mal, de estar diciendo algo inadecuado, de ser malinterpretado.
...
- **Irritabilidad sensorial aumentada**: los ruidos de siempre empiezan a resultar insoportables.
- **Dificultad para hacer masking**: cuesta más mantener el filtro social, aparecen respuestas más directas o reacciones que normalmente se controlan.
- **Incapacidad de hacer nada al llegar a casa**: no es pereza. Es que el sistema ya no tiene nada más.
- **Dificultad para hablar**: al final del día, las palabras cuestan. Las conversaciones de cualquier tipo se vuelven un esfuerzo enorme.
- **Pensamiento rumia activo**: el cerebro sigue procesando las interacciones del día en bucle, sin soltar.
- **Disminución del rendimiento en tareas que antes eran automáticas**: errores en cosas simples, dificultad para concentrarse en lo que habitualmente fluye bien.
...
**¿Por qué me agoto más que mis compañeros haciendo exactamente lo mismo?**
Porque no estás haciendo exactamente lo mismo. Estás haciendo lo mismo que ellos más el procesamiento sensorial constante, más el análisis social activo, más el masking, más la gestión de la ambigüedad. Tus compañeros neurotípicos hacen parte de eso de forma automatizada y con un costo neurológico mucho menor. No es que tú rindas menos. Es que partes con una carga diferente.

**¿El agotamiento laboral Asperger es reversible?**
...
**¿Cómo pido ajustes razonables en el trabajo sin revelar mi diagnóstico?**
...
- [Rupturas Asperger](/rupturas-asperger)
- [Fortalezas Asperger](/fortalezas-asperger)
- [Neurodiversidad Asperger](/neurodiversidad-asperger)