---
title: "Adaptaciones Laborales Asperger"
description: "Todo lo que necesitas saber sobre adaptaciones laborales asperger. Cómo se vive desde el perfil neurocognitivo Asperger en la vida real."
cluster: "Trabajo y vida adulta Asperger"
related: ["diagnostico-asperger", "amistad-asperger", "estrategias-regulacion-asperger"]
keywords: ["adaptaciones laborales asperger", "adaptaciones laborales asperger autismo", "perfil asperger adaptaciones laborales asperger"]
bloques: ["C", "F"]
schema_questions:
  - question: "¿Qué adaptaciones laborales puede pedir una persona con perfil Asperger?"
    answer: "Las más efectivas y de menor coste: instrucciones y resúmenes de reuniones por escrito, espacio para trabajo sin interrupciones, comunicación interna escrita, criterios explícitos de evaluación y preaviso de cambios con antelación. Ninguna requiere revelar el diagnóstico — se pueden pedir como preferencias de trabajo."
  - question: "¿Hay que revelar el diagnóstico Asperger para pedir adaptaciones laborales?"
    answer: "No necesariamente. La mayoría de las adaptaciones útiles para el perfil Asperger se pueden pedir formulándolas como preferencias de eficiencia, sin mencionar el diagnóstico. Solo es relevante revelarlo si se quiere acceder a protecciones legales formales, y esa decisión es siempre personal."
  - question: "¿Qué hago si mi empleador rechaza las adaptaciones que pido?"
    answer: "Primero, reformular la petición en términos de rendimiento y eficiencia. Segundo, escalarla a recursos humanos con documentación. Si existe diagnóstico formal y el rechazo afecta el desempeño, en muchos países hay marcos legales de ajustes razonables que obligan al empleador a considerarlas."
  - question: "¿Es obligatorio decir en el trabajo que eres Asperger?"
    answer: "No. Revelar el diagnóstico en el trabajo es una decisión personal, no una obligación. Solo es necesario si se quiere acceder a adaptaciones formales o protecciones legales. En la mayoría de los contextos, las adaptaciones cotidianas se pueden pedir sin mencionar el diagnóstico."
---
...
**¿Tengo que revelar mi diagnóstico para pedir adaptaciones?**
...
**¿Qué adaptaciones puedo pedir en el trabajo?**
Las más comunes y efectivas: instrucciones y resúmenes por escrito, espacio o tiempo para trabajo sin interrupciones, comunicación interna preferentemente escrita, criterios explícitos de evaluación, preaviso de cambios con antelación, y flexibilidad de horario para proteger bloques de concentración. Son adaptaciones razonables, de bajo coste y beneficiosas para cualquier equipo — no solo para el perfil Asperger.

**¿Qué hago si mi empleador rechaza mis adaptaciones?**
Primero, reformular la petición en términos de eficiencia y rendimiento si no se hizo así. Segundo, escalarla a recursos humanos con una solicitud formal y documentada. Tercero, si existe diagnóstico formal y el rechazo afecta la capacidad de desempeñar el trabajo, consultar con un profesional de orientación laboral especializado en neurodiversidad — en muchos países hay marcos legales que obligan a los empleadores a considerar ajustes razonables.

## Relacionado con el perfil Asperger
- [Diagnóstico Asperger](/diagnostico-asperger)
- [Amistad Asperger](/amistad-asperger)
- [Estrategias Regulacion Asperger](/estrategias-regulacion-asperger)

## Inclusión laboral para el perfil Asperger

Navegar el entorno laboral con el perfil Asperger es más fácil con una red que lo entiende:

- 💼 [Bolsa de empleo Auténticamente Capaces](https://www.autenticamentecapaces.work) — ofertas en empresas que valoran la neurodiversidad
- 🎓 [Plan Embajador](https://www.aspergerparaasperger.org/plan-embajador-asperger-para-asperger/) — acompañamiento para encontrar el entorno laboral adecuado y mantenerse en él
