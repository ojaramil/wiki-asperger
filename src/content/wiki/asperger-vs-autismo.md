...
- "Asperger" sigue siendo un término válido y ampliamente usado por la comunidad, aunque ya no sea diagnóstico oficial en el DSM-5.
- "TEA nivel 1" es el diagnóstico formal actual en muchos países que siguen el DSM-5.
- "Autismo de alto funcionamiento" es un término problemático porque el "funcionamiento" es contextual y variable, y puede ocultar dificultades reales bajo una etiqueta que suena a suficientemente capaz.
- Lo más respetuoso, siempre, es usar el término que cada persona usa para sí misma.
...
**¿Asperger es autismo de alto funcionamiento?**
